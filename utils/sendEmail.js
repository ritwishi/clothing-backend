...
export const sendOrderConfirmationEmail = async (order, user) => {
  try {
    ...
    // Email HTML template (same design as your Gmail version)
    const htmlTemplate = `
      <!DOCTYPE html>
      <html>
      <body style="font-family: Arial; background: #f5f5f5; padding: 0; margin: 0;">
        <div style="max-width:600px; margin:20px auto; background:#fff; padding: 20px; border-radius:8px;">
          ...
          <table style="width:100%; border-collapse:collapse;">
            <thead>
              <tr>
                <th style="padding:10px; background:#667eea; color:#fff;">Product</th>
                <th style="padding:10px; background:#667eea; color:#fff;">Size</th>
                <th style="padding:10px; background:#667eea; color:#fff;">Qty</th>
                <th style="padding:10px; background:#667eea; color:#fff;">Price</th>
              </tr>
            </thead>
            <tbody>
              ${itemsHTML}
          ...
          <p>We'll send you tracking details soon.</p>
  ...
  try {
    ...
    const htmlTemplate = `
      ...
      <body style="font-family: Arial; background: #f5f5f5;">
        <div style="max-width:600px; background:white; padding:20px; margin:20px auto; border-radius:8px;">
          <h2 style="color:#667eea;">Welcome to Clothing Store 🎉</h2>
          <p>Hi <strong>${user.name}</strong>,</p>
          <p>Thanks for creating an account with us! We're excited to have you.</p>
          <p>Start exploring our latest fashion collection now.</p>
